...
namespace IndentityServer.EntityFramework
{
    public static class EntitiesMap
    {
        ...
        static EntitiesMap()
        {
            ...
            {
                config.CreateMap<Entities.Scope, IdentityServer4.Core.Models.Scope>(MemberList.Destination)
                ...
                config.CreateMap<Entities.ScopeClaim, IdentityServer4.Core.Models.ScopeClaim>(MemberList.Destination);
                config.CreateMap<Entities.ScopeSecret, IdentityServer4.Core.Models.Secret>(MemberList.Destination)
                    .ForMember(dest => dest.Type, opt => opt.Condition(srs => !srs.IsSourceValueNull));

                config.CreateMap<Entities.ClientSecret, IdentityServer4.Core.Models.Secret>(MemberList.Destination)
                     .ForMember(dest => dest.Type, opt => opt.Condition(srs => !srs.IsSourceValueNull));
                config.CreateMap<Entities.Client, IdentityServer4.Core.Models.Client>(MemberList.Destination)
        ...
        public static IdentityServer4.Core.Models.Scope ToModel(this Entities.Scope s)
        {
            if (s == null) return null;
            return Mapper.Map<Entities.Scope, IdentityServer4.Core.Models.Scope>(s);
        }

        public static IdentityServer4.Core.Models.Client ToModel(this Entities.Client s)
        {
            if (s == null) return null;
            return Mapper.Map<Entities.Client, IdentityServer4.Core.Models.Client>(s);
        }
    }
}
